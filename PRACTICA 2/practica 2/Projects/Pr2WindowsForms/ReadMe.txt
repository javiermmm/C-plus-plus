========================================================================
   APLICACIÓN: Pr2WindowsForms Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Pr2WindowsForms.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Pr2WindowsForms.

Pr2WindowsForms.vcxproj
...
Pr2WindowsForms.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Pr2WindowsForms.pch y un archivo de tipos 
