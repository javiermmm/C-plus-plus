========================================================================
   APLICACIÓN: MideMedalleroWin Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación MideMedalleroWin.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación MideMedalleroWin.

MideMedalleroWin.vcxproj
...
MideMedalleroWin.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado MideMedalleroWin.pch y un archivo de tipos 
