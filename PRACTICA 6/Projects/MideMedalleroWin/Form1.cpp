					 ...
					 if ((this->tbTamIni->Text != "") && (this->tbTamFin->Text != "") && (this->tbIncremento->Text != "") && (this->tbRepeticionesIni->Text != "") && (this->tbRepeticionesFin->Text != "")) {
						 ...
						 if (this->cbAlgoritmo->SelectedIndex != -1){
								 switch (this->cbAlgoritmo->SelectedIndex) {
									case 0:  {alg = new CAlgoritmoMedallero<CMedalleroTAbierta> ();
											  nombre = "Medallero_NPaisesTAbierta.txt";
											  nomFichero = "Medallero_NPaisesTAbierta.png";
											  break;
											 }

									case 1: {alg = new CAlgoritmoMedalleroOrdenado<CMedalleroTAbierta>();
											 nombre = "MedalleroOrdenado_NPaisesTAbierta.txt";
											 nomFichero = "MedalleroOrdenado_NPaisesTAbierta.png";
											 break;
											}

									case 2: {alg = new CAlgoritmoMedalleroDeporteAleatorio<CMedalleroTAbierta>();
											 nombre = "MedalleroDeporte_DeporteAleatorioTAbierta.txt";
											 nomFichero = "MedalleroDeporte_DeporteAleatorioTAbierta.png";
											 break;
											}
									
									case 3: {alg = new CAlgoritmoMedalleroDeporteAleatorioOrdenado<CMedalleroTAbierta>();
											 nombre = "MedalleroDeporteOrdenado_DeporteAleatorioTAbierta.txt";
											 nomFichero = "MedalleroDeporteOrdenado_DeporteAleatorioTAbierta.png";
											 break;
											}
									 
									case 4: {alg = new CAlgoritmoClasificacionPrimero<CMedalleroTAbierta>();
											 nombre = "Clasif_NPaisesPrimeroTAbierta.txt";
											 nomFichero = "Clasif_NPaisesPrimeroTAbierta.png";
											 break;
											}

									case 5: {alg = new CAlgoritmoClasificacionUltimo<CMedalleroTAbierta>;
											 nombre = "Clasif_NPaisesUltimoTAbierta.txt";
											 nomFichero = "Clasif_NPaisesUltimoTAbierta.png";
											 break;
											}

									case 6: {alg = new CAlgoritmoClasificacionAleatorio<CMedalleroTAbierta>();
											 nombre = "Clasif_NPaisesAleatorioTAbierta.txt";
											 nomFichero = "Clasif_NPaisesAleatorioTAbierta.png";
											 break;
											}
								}
